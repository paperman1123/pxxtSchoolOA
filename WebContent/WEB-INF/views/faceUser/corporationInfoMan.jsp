	...
	<!-- ---------------------------------------------------侧边栏------------------------------------------------------ -->
			...
			<section class="user-info-content">
				<div class="user-img">
					...
					<a onclick="activateFileInput()">更改logo</a>
					<input type="file" id="changeLogo" onchange="changeLogoChange()" style="display: none;">
				</div>
				<div class="user-info">
					<form>
						<ul class="user-info-text">
							<li><label>社团名称</label><input id="corporation_name" placeholder="计算机协会" readonly="true" type="text" value="<s:property value="corporationInfo.corporation_name"/>"/></li>
							<li><label>立社时间</label><input readonly="true" id="corporation_apply_time" class="calender" type="text" value="<s:property value="corporationInfo.corporation_apply_time"/>"/></li>
							<li class="summary"><label>编辑简介</label>
							<textarea class="form-control textarea1" rows="8" id="corporation_introduce"><s:property value="corporationInfo.corporation_introduce"/></textarea></li>
						    <div style="cursor: pointer;" class="submit" id="submitUpdate" onclick="uploadUpdateCorInfo()">保存修改</div>
						</ul>
					</form>
				</div>
			</section>
		...
		<script>
			//日期设置
			$('#corporation_apply_time').datetimepicker({
				language: 'zh-CN', //显示中文
