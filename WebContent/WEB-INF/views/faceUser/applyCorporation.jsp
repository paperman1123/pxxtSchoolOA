	...
	<!--固定社团入驻按钮 end-->
			...
			<div class="cor-show">
				...
				<s:iterator value="applyVO.corporationInfo" id="corporation">
					<div class="cor-box">
						<div class="cor">
							<img src="<%=basePath %>manager/apply_downloadImg?fileDirc=corporationLogo&filename=<s:property value="#corporation.corporation_logo"/>" />
							<a><s:property value="#corporation.corporation_name"/></p>
								<p><s:property value="#corporation.corporation_introduce"/></p>
							</a>
							<a id="<s:property value="#corporation.corporation_id"/>" onclick="applyCorporation(this)">加入</a>
							<div class="line"></div>
						</div>
					</div>
				</s:iterator>
