...
<body>
	...
	<div style="margin: 50px 0 0 260px; width: calc(100% - 260px);">
		...
		<table style="width: 95%; margin: 0 auto; text-align: center;">
			<tr>
				<td style="height: 50px;">
					...
					<button class="searchbtn"  id="add" data-toggle="modal"
		...
		<s:if
				test="page_list_userInfo.userInfoDTOList == null || page_list_userInfo.userInfoDTOList.size() == 0">
						没有用户
		</s:if>
		<s:else>
		<table id="table"
			...
			<s:iterator value="page_list_userInfo.userInfoDTOList" id="NACACDTOL">
				<tr>
								<td><s:property value="#NACACDTOL.userInfo.user_name"
							escape="false" /></td>
							    <td><s:property value="#NACACDTOL.userInfo.user_nickname"
							escape="false" /></td>
								<td><s:property value="#NACACDTOL.userInfo.user_username"
							escape="false" /></td>
								<td><s:property value="#NACACDTOL.userInfo.user_birthday"
							escape="false" /></td>
								<td><s:property value="#NACACDTOL.userInfo.user_introduce"
							escape="false" /></td>
								<td><s:property value="#NACACDTOL.userInfo.user_sex"
							escape="false" /></td>
								<td><s:property value="#NACACDTOL.userInfo.user_telephone"
							escape="false" /></td>
								<td><s:property value="#NACACDTOL.userInfo.user_address"
							escape="false" /></td>
								<td><s:property value="#NACACDTOL.userInfo.user_role"
							escape="false" /></td>
				
					<td><button class="btn btn-primary" style="margin: 5px;"
							value="<s:property value="#NACACDTOL.userInfo.user_id"
							escape="false" />" onclick="updateUser(this)"
					...
					<td>
						<button class="btn btn-danger" style="margin: 5px;"
							id="<s:property
							value="#NACACDTOL.userInfo.user_id"
													escape="false" />"
		...
		<%-- <s:property value="page_list_userInfo.pageIndex-1" /> --%>
					<!-- //分页 -->
