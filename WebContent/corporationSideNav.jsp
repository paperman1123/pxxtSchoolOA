...
<aside class="side-nav">
				<div class="nav">
					...
					<s:if test="currMember.member_role>=1">
						...
						<a onclick="skipToShowAnno()"><span class="nav-second"><img src="<%=basePath %>img/secondnav.png">公告查看</span></a>
					<s:if test="currMember.member_role>=1">
				...
				<div class="nav">
					...
					<s:if test="currMember.member_role>=1">
						<a><span class="nav-second" onclick="skipToAnnoMan()"><img src="<%=basePath %>img/secondnav.png">公告管理</span></a>
					</s:if>
					<s:if test="currMember.member_role>=1">
					...
					<s:if test="currMember.member_role>=2">
