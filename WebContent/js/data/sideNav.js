...
function skipToShowAnno(){
	var curCorporation = document.getElementById("currCorporation");
	window.location="/corporation/manager/manager_skipToShowAnno?member_corporation="+curCorporation.innerHTML+"&queryStartTime=0000-00-00&queryEndTime=9999-99-99&queryName=&timeSort=desc&currPage=1";	
}