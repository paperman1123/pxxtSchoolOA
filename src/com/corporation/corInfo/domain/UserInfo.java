...
public class UserInfo {
	...
	public String toString() {
		return "UserInfo [user_id=" + user_id + ", user_name=" + user_name + ", user_nickname=" + user_nickname
				+ ", user_username=" + user_username + ", user_password=" + user_password + ", user_logo=" + user_logo
				+ ", user_birthday=" + user_birthday + ", user_introduce=" + user_introduce + ", user_sex=" + user_sex
				+ ", user_telephone=" + user_telephone + ", user_address=" + user_address + ", user_role=" + user_role
