...
public class CorporationInforDaoImpl implements CorporationInforDao {
	...
	public void setMemberUser(String currUser, String currMember) {
		// TODO Auto-generated method stub
		System.out.println("同意申请之后设置会员信息:" + currMember);
	...
	@Override
	public int getAnnouncementCount(announcementDTO annoD) {
		// TODO Auto-generated method stub
		String announcement_name = "%" + annoD.getQueryName() + "%";
		String hql = "select count(*) from corporation_announcement where announcement_name like '" + announcement_name
				+ "' and announcement_gmt_create <= '" + annoD.getQueryEndTime() + "' and announcement_gmt_create>= '"
				+ annoD.getQueryStartTime() + "' and announcement_belone ='" + annoD.getCurrCorporation() + "'";
	...
	@Override
	public List<corporation_announcement> getAnnouncementByPage(announcementDTO annoD, double pageSize) {
		// TODO Auto-generated method stub
		String announcement_name = "%" + annoD.getQueryName() + "%";
		String hql = "from corporation_announcement where announcement_name like '" + announcement_name
				+ "' and announcement_gmt_create <= '" + annoD.getQueryEndTime() + "' and announcement_gmt_create>= '"
				+ annoD.getQueryStartTime() + "' and announcement_belone ='" + annoD.getCurrCorporation()
				+ "' order by announcement_gmt_create " + annoD.getQuerySort();
		Query query = getSession().createQuery(hql).setFirstResult((annoD.getCurrPage() - 1) * (int) pageSize)
				.setMaxResults((int) pageSize);
		List<corporation_announcement> list = query.list();
		return list;
	}

	@Override
	public void addAnnouncement(corporation_announcement ca) {
		// TODO Auto-generated method stub
		getSession().save(ca);
	}

	@Override
	public void deleteAnnouncement(String announcement_id) {
		// TODO Auto-generated method stub
		String hql = "delete corporation_announcement where announcement_id = '" + announcement_id + "'";
		getSession().createQuery(hql).executeUpdate();
	}

	@Override
	public corporation_announcement getAnnouncementById(String announcement_id) {
		// TODO Auto-generated method stub

		corporation_announcement ano = (corporation_announcement) getSession().get(corporation_announcement.class,
				announcement_id);
